...
export function detectFocusVisible(instance, element, callback, attempt = 1) {
	warning(instance.focusVisibleCheckTime, 'UI: missing instance.focusVisibleCheckTime.');
	warning(instance.focusVisibleMaxCheckTimes, 'UI: missing instance.focusVisibleMaxCheckTimes');
...
export function listenForFocusKeys(win) {
	...
	// This logic is for client side only, no need for a teardown.
